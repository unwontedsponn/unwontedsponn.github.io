// piano ------------------------------------------------------------------------ 
// created from this YouTube series:
// https://www.youtube.com/watch?v=arq0YjZPvAQ&list=PLXAhCH9FJ8zVhF7skX2ppb92UMs4DkFS2&index=2&ab_channel=MusicandCoding -------------------------
// didn't do part 9 as thought it looked better without the workaround
...
const pianoNoteHighlighter = {
	...
	displayNotes(piano, notes) {
		const pianoKeys = piano.querySelectorAll(".key");
...
const piano_1 = document.querySelector("#piano_1");
const range = ["A0", "C8"];

// pianoNoteHighlighter.getAllNaturalNotes(piano_1, ["A0", "C8"])
pianoNoteHighlighter.setupPiano(piano_1);
pianoNoteHighlighter.displayNotes(piano_1, ["C1", "C2", "C3", "C4", "C5", "C6", "C7", "C8"]);

pianoNoteHighlighter.setupPiano(piano_2);
pianoNoteHighlighter.displayNotes(piano_2, ["C3", "C4", "C5"]);

pianoNoteHighlighter.setupPiano(piano_3);
pianoNoteHighlighter.displayNotes(piano_3, ["F1", "F2", "F3", "F4", "F5", "F6", "F7"]);

pianoNoteHighlighter.setupPiano(piano_4);
pianoNoteHighlighter.displayNotes(piano_4, []);


// console.log(pianoNoteHighlighter.getAllNaturalNotes(range));
